...
PDFGeneratorURLContentTask = (function(superClass) {
  ...
  PDFGeneratorURLContentTask.prototype.executeOn = function(page, callback) {
    var alreadyFailed, failWithError, pageDidOpen;
    alreadyFailed = false;
    ...
    console.log("Content task started for " + this.url);
    pageDidOpen = false;
    return async.auto({
        ...
        return function(next, results) {
          return setPageSettings(page, {
            ...
            'onResourceRequested': function(res) {
              if (page.resourcesRequested == null) {
                page.resourcesRequested = 0;
              }
              return page.resourcesRequested += 1;
            },
            'onResourceReceived': function(res) {
              if (res.stage !== 'end') {
                return;
              }
              if (page.resourcesReceived == null) {
                page.resourcesReceived = 0;
              }
              return page.resourcesReceived += 1;
            },
            'onUrlChanged': function(newURL) {
              ...
              if (newURL === _this.url) {
                return pageDidOpen = true;
              }
            },
            'onLoadFinished': function(arg1) {
              return console.log("onLoadFinished: " + arg1 + ".");
            }
          }, next);
        };
      })(this),
      'openPage': [
        'setup', (function(_this) {
          return function(next, results) {
            console.log("opening " + _this.url);
            page.open(_this.url);
            return _this.waitFor((function(cb) {
              return cb(pageDidOpen === true);
            }), next, _this.timeout);
          };
        })(this)
      ],
      'allResourcesLoaded': [
        'openPage', (function(_this) {
          return function(next, results) {
            console.log("open");
            return _this.waitFor((function(cb) {
              return cb(page.resourcesRequested === page.resourcesReceived);
            }), next, _this.timeout);
          };
        })(this)
      ],
      ...
      'waitForReady': [
        'shouldWaitForReady', (function(_this) {
          return function(next, results) {
      ...
      'allResourcesLoaded2': [
        'waitForReady', (function(_this) {
          return function(next, results) {
            console.log("Ready");
            return _this.waitFor((function(cb) {
              console.log(page.resourcesRequested, page.resourcesReceived);
              return cb(page.resourcesRequested === page.resourcesReceived);
            }), next, _this.timeout);
          };
        })(this)
      ...
      'injectStyles': [
        'allResourcesLoaded2', (function(_this) {
          return function(next, results) {
